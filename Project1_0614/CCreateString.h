...
public:
	// デフォルトコンストラクタを制限
	CCreateString() = delete;

	// コンストラクタ
	// 第1引数：フォント設定
	CCreateString(FontData* set) :Setting(set) {};
...
// pos：描画ポジション
// options：テキストの整形
	void DrawString(std::string str, XMFLOAT2 pos, D2D1_DRAW_TEXT_OPTIONS options);
