...
public:
	...
	std::vector<MonsterDataList> g_monsterlist = {
		{MY_MONSTER::BACK,"assets/UI/Ç‡Ç«ÇÈ_onoff.png",1120, 570,180,120,{1,1}, {1,1,1,1},false,
		{uv[0],uv[1],uv[2],uv[3]},{uv0[0],uv0[1],uv0[2],uv0[3]},0,false,false},
		{MY_MONSTER::BACK_SHADOW,"assets/UI/óßëÃâe_Ç‡Ç«ÇÈ2.png",1107, 580,180,120,{1,1}, {1,1,1,1},false,
		{uv2D[0],uv2D[1],uv2D[2],uv2D[3]},{uv2D[0],uv2D[1],uv2D[2],uv2D[3]},false,false},
		{MY_MONSTER::MONSTER_DATA_FRAME,"assets/UI/Battle/Command/Monster/òg_icon.png",180, 140,130,130,{1,1}, {1,1,1,1},false,
		{uv2D[0],uv2D[1],uv2D[2],uv2D[3]},{uv2D[0],uv2D[1],uv2D[2],uv2D[3]},false,false},
		...
		{uv2D[0],uv2D[1],uv2D[2],uv2D[3]},{uv2D[0],uv2D[1],uv2D[2],uv2D[3]},false,false},
		{MY_MONSTER::MONSTER_WINDOW,"assets/UI/Battle/Command/Monster/monster_window_base.png",640,360,1360,800,{1,1}, {1,1,1,1},false,
		{uv2D[0],uv2D[1],uv2D[2],uv2D[3]},{uv2D[0],uv2D[1],uv2D[2],uv2D[3]},false,false},
	};
	bool Init();
	void Draw();
